...
export default function IndexPage() {
  return (
    <DefaultLayout>
      <Card className="w-full h-[550px] relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center bg-black/50">
          <div className={title({ class: "text-white my-4 " })}>
            Bridging the gap between the ground and the cloud
          </div>
          <div className={subtitle({ class: "text-white px-20" })}>
      ...
      >
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center bg-black/50">
          <div className={title({ class: "text-white my-4 " })}>About</div>
          <div className="text-white text-lg px-20">
      ...
      >
        ...
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center bg-black/50">
          <div className={title({ class: "text-white my-4 " })}>Work</div>
          <div className="text-white text-lg px-20">
